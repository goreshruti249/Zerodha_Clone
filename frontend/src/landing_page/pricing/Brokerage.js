        ...
        <div className='row border-top p-5'>
          <div className='col-8'>
            <a href="#" style={{textDecoration:"none"}}>
              <h4 className='text-center p-3'>Brokerage calculator</h4></a>
            <ul className='text-muted'style={{textAlign:"left",lineHeight:"2rem"}}>
          ...
          <div className='col-4'>
            <a href="#"style={{textDecoration:"none"}}>
              <h4 className='text-center p-3'>List of charges</h4></a>
          </div>
        </div>
      </div>
    </>
