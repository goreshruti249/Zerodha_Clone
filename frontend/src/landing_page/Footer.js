...
function Footer() {
    return (
        <footer style={{backgroundColor:"rgba(244, 241, 241, 1)"}}>
         <div className="container border-top p-3">
            <div className="row ">
                <div className="col">
                    <img src="media/images/logo.svg" style={{ width: "50%" }}></img>
                    <p className="para mt-3">&copy; 2010 - 2024, Not Zerodha Broking Ltd. All rights reserved.</p>
                </div>
            ...
            <div className="footerPara mt-5 font-muted" style={{fontSize:"14px"}}>
